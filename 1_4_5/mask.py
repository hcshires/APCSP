...
def round_corners_one_image(original_image, percent_of_side=.3):
    ...
    drawing_layer.polygon([(radius,0),(width-radius,0),
                            ...
                            fill=(127,0,127,255)) # 255 = opaque. Defines the parts that show up
    ...
    result = PIL.Image.new('RGBA', original_image.size, (0,0,0,0)) # new background to paste the image on
