...
def frame_image(original_image, bw = 20, color = black): # bw = border width
	...
	drawing_layer.ellipse([(0, height/4), (width/2, height-100)], fill = black)
	drawing_layer.ellipse([(width/2, height/4), (width, height-100)], fill = black)
	
	# For text
	drawing_layer.text((width/3, 50), "I'm watching you Mike Wazowski, always watching...", fill = (255, 255, 255, 255))
