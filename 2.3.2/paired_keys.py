...
def crypt_number(n_d_or_e, number_message):
    ...
    from the same pair. 
    """
    n, d_or_e = n_d_or_e  # split tuple into variables
...
def use_key(n_d_or_e, number_message, chunk_size=4):
...
# print(prime_factors(56)) # Returns factors that multiply to 56
print(prime_factors(11)) # Returns itself since it is prime